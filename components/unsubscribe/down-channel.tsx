...
const channels = [
  {
    ...
    href: "https://discord.novu.co?utm_source=preference_center&utm_medium=web&utm_content=discord",
    icon: <MessageCircle className="h-4 w-4" />,
  },
  {
    name: "Contact Support",
    description: "We're here to help",
    href: "https://novu.co/contact-us?utm_source=preference_center&utm_medium=web&utm_content=contact_support",
    icon: <HelpCircle className="h-4 w-4" />,
  },
  {
    name: "Follow on LinkedIn",
    description: "Bite-sized updates",
    href: "https://www.linkedin.com/company/novuhq?utm_source=preference_center&utm_medium=web&utm_content=linkedin",
    icon: (
  ...
  },
  {
    ...
    href: "https://x.com/novuhq?utm_source=preference_center&utm_medium=web&utm_content=twitter",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
